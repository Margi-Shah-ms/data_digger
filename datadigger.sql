...
('Alice', 'alice.smith@example.com', '101 Maple St'),
('David', 'david@example.com', '202 Birch St');
...
(1, '2023-10-15', 800.00),
(3, '2023-11-05', 1500.00),
(4, '2023-11-10', 600.00),
(1, '2023-11-12', 2500.00);
...
AVG(TotalAmount) AS averageamount FROM Orders;
